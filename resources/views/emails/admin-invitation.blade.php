...
<head>
    ...
    <title>You're Invited to Join as an Administrator</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>You've been invited to join TrainOS as an <strong>administrator</strong>. As an admin, you'll have access to manage trainers, users, and platform settings.</p>
